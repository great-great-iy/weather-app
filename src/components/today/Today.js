    ...
    return (
        <div className="row tab-today">
            ...
            <div className="tab-today__item col zoom-in">
                <div className="box">
                    <div className="box-content">
                        <div className="box-desc">UV index</div>
            ...
            <div className="tab-today__item col zoom-in">
                <div className="box ">
                    <div className="box-content">
                        <div className="box-desc">Wind Status</div>
                        <div className="box-icon">
                            <svg
                                stroke="currentColor"
                                fill="currentColor"
                        ...
                        <div className="box-value">{speed} km/h</div>
                    </div>
                </div>
            </div>
            ...
            <div className="tab-today__item col zoom-in">
                <div className="box">
                    <div className="box-content">
                        <div className="box-desc">Sunrise & Sunset</div>
                        <div className="box-icon">
            ...
            <div className="tab-today__item col zoom-in">
                <div className="box">
                    <div className="box-content">
                        <div className="box-desc">Humidity</div>
                        <div className="box-icon">
                            <svg
                                stroke="currentColor"
                                fill="currentColor"
            ...
            <div className="tab-today__item col zoom-in">
                <div className="box">
                    <div className="box-content">
                        <div className="box-desc">Visibility</div>
                        <div className="box-icon">
                            <svg
                                stroke="currentColor"
                                fill="currentColor"
                        ...
                        <div className="box-value">{visibility / 1000} Km</div>
                    </div>
                </div>
            </div>
            ...
            <div className="tab-today__item  col zoom-in">
                <div className="box">
                    <div className="box-content">
                        <div className="box-desc">Pressure</div>
                        <div className="box-icon">
                            <svg
                                stroke="currentColor"
                                fill="currentColor"
                        ...
                        <div className="box-value">{pressure} hPa</div>
                    </div>
                </div>
            </div>
        </div>
